...
feature5 = st.selectbox("Choose your education_level", options=list(education_level.keys()), format_func=format_func)
...
feature6 = st.selectbox("Choose your Job_type", options=list(job_type.keys()), format_func=format_func)
